...
{
  printf("=====================================================================================\n");
  printf("Usage:> %s -t/s <dt> <tmax> <mesh_file> <steady_state_file> [ALPHA] [d1]\n",pName);
  printf("-------------------------------------------------------------------------------------\n");
  ...
  printf("-------------------------------------------------------------------------------------\n");
  printf("Steady-State Example: %s -t 0.1 5000 cable_dog.msh steady_dog.sst 1.375 0.002\n",pName);
  printf("Solver Example: %s -s 0.1 1000 cable_dog.msh steady_dog.sst 1.375 0.002\n",pName);
  printf("-------------------------------------------------------------------------------------\n");
}
