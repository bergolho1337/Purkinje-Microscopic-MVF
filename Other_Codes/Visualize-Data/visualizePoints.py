...
# ---------------------------------------------------------------
# Usage:> python visualizePoints.py --<plot-format> <input-file>
...
def main ():
    ...
    if (len(sys.argv)-1 != 2):
        print("---------------------------------------------------------------")
        print("Usage:> python visualizePoints.py --<plot-format> <input-file>")
    ...
    data = np.genfromtxt(open(sys.argv[2],"r"))
