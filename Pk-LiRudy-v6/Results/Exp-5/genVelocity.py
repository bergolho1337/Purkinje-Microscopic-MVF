...
pyplot.plot(data2[:,0],data2[:,1],label="80 %",linewidth=2,marker='o')
pyplot.plot(data3[:,0],data3[:,1],label="70 %",linewidth=2,marker='o')
pyplot.ylim([0,3.0])
...
pyplot.grid()
pyplot.savefig("lvl-velocity-LiRudy.pdf")
