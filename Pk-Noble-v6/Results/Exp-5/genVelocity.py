...
pyplot.plot(data1[:,0],data1[:,1],label="90 %",linewidth=2,marker='o')
pyplot.plot(data2[:,0],data2[:,1],label="80 %",linewidth=2,marker='^')
pyplot.plot(data3[:,0],data3[:,1],label="70 %",linewidth=2,marker='s')
pyplot.ylim([0,2.7])
...
pyplot.grid()
pyplot.savefig("lvl-velocity-Noble-revision.pdf")
