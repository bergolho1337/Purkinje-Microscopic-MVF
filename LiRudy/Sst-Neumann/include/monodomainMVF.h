...
struct Volume
{
  double vOld;                               // Contem a solucao no instante n     {v^n}
  double vNew;                               // Contem a solucao no instante n+1   {v^n+1}
  double vStar;                              // Contem a solucao no instante n+1/2 {v^n+1/2}
  Cell *cell;                                // Estrutura de celula ligada a solucao da EDO
}typedef Volume;
